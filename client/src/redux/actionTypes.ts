...
export const SET_ADDED_WORDS_COUNT = "[PREFERENCE] SET_ADDED_WORDS_COUNT" //
export const SET_DELETED_WORDS_COUNT = "[PREFERENCE] SET_DELETED_WORDS_COUNT" //
export const INCREMENT_ADDED_WORDS_COUNT = "[PREFERENCE] INCREMENT_ADDED_WORDS_COUNT" //
export const INCREMENT_DELETED_WORDS_COUNT = "[PREFERENCE] INCREMENT_DELETED_WORDS_COUNT" //
export const SET_NEW_WORD_ADDING_TYPE = "[PREFERENCE] SET_NEW_WORD_ADDING_TYPE"
// years
