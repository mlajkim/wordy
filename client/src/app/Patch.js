...
const patch1_2 = {
  ...
  contents: [
    {
      title: 'You can securely pay through PayPal now.',
      explain: 'Pay with PayPal securely! Set up automated payment!'
    },
    {
      title: 'Minor bug fixes',
      explain: 'Fix minor bug issues'
    }
  ],
  philosophy: [
...
// ***************************************************************************
 ...
 // ***************************************************************************
 const patch_list = [patch1_2, patch1_1, patch1_0];
 export default patch_list;